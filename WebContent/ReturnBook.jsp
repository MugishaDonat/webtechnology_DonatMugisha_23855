...
<body>
    <header class="navbar">
        <div class="logo">AUCA Library - Return Book</div>
        <div class="nav-links">
    ...
    <main class="container">
        ...
        <form action="ReturnBookServlet" method="post">
            <label for="isbn">Enter Book code to Return:</label>
            <input type="text" id="isbn" name="isbn" required>

            <c:if test="${isLate}">
    <p style="color: red;">This book is late.</p> 
    <p style="color: red;">Late Fee: Rwf ${lateFee}</p>
</c:if>
