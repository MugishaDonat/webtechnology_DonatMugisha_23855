...
<head>
    <meta charset="UTF-8">
    <title>Assign Book to Shelf Category</title>
    <link rel="stylesheet" href="css/dash.css">
</head>
<body>
    <header class="navbar">
        <div class="logo">AUCA Library - Assign Book to Shelf Category</div>
        <div class="nav-links">
    ...
    <main class="container">
        <h3>Assign Book to Shelf Category</h3>
        <form action="BookShelfAssignmentServlet" method="post">
            <label for="bookName">SBNcode:</label>
            <input type="text" id="sbn" name="sbn" required>
    ...
    <option value="Mathematics">Mathematics</option>
          ...
          <button type="submit">Assign Book to Category</button>
          </form>
 </main>
