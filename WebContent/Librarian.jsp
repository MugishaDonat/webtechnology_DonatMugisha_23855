...
<body>
    ...
    <main class="container">
        ...
        <div class="search-container">
            <h3>Find user location</h3>
            <form action="searchByPhone.jsp" method="GET">
                <label for="phoneNumber">Enter Phone Number:</label>
                <input type="text" id="phoneNumber" name="phoneNumber" required placeholder="e.g. +250 7888 6969">
        ...
        <div class="options">
            <a href="manageBooks.jsp" class="button"> Books</a>
            <a href="manageLocation.jsp" class="button">Manage Locations</a>
            <a href="assignshelf.jsp" class="button">Assign Shelf</a>
            <a href="assignroom.jsp" class="button">Assign Rooms</a>
            <a href="requests.jsp" class="button">Requests</a>
        </div>
